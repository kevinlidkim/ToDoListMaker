...
<div style="position:relative;text-align:center;height:250px;color:white;background-color:#7289DA;overflow:hidden;width:100vw;">
	...
	<div style="font-size:4em;font-weight:600;text-align:center;margin-top:80px;position:relative;z-index:2;">${message} guestbook</div>
</div>
...
>>>>>>> d878e9fa718b5e6db7dcb735acbcb2388072e088
